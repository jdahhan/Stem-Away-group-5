...
class PrepareStanfordParser:
    ...
    def get_genes(self, path = '/Users/mtaruno/Documents/DevZone/Stem-Away-group-5/data/genes/genes.tsv'):
        return list(pd.read_csv(path, delimiter="\t")['Name'])

    def get_drugs(self, path = '/Users/mtaruno/Documents/DevZone/Stem-Away-group-5/data/drugs/drugs.tsv'):
        return list(pd.read_csv(path, delimiter="\t")['Name'])
